                        ...
                        >
                            <Form>
                                ...
                                <div className="flex items-center space-x-2 mb-6">
                                    <Checkbox id="show-password" onCheckedChange={toggleCheck} className="peer data-[state=unchecked]:border-[#3563e9] data-[state=checked]:bg-[#3563e9] data-[state=checked]:border-[#3563e9]" />
                                    <label
